...
class DefaultConfig(object):
    ...
    TWIST_CANDY_DETECTOR_HISTGRAM_THRES = 2.7e-3  # 2.7e-3
    TWIST_CANDY_DETECTOR_BIN_THRES = 150  # 150
    TWIST_CANDY_DETECTOR_EDGE3_THRES = 250  # 250
    TWIST_CANDY_DETECTOR_EDGE5_THRES = 230  # 230
    TWIST_CANDY_DETECTOR_MARGIN = (30, 30)  # (30,30)
    TWIST_CANDY_DETECTOR_CLOSING_ITER = 2
    TWIST_CANDY_DETECTOR_OPENING_ITER = 5
    TWIST_CANDY_DETECTOR_ERODE_ITER = 1  # 25
    TWIST_CANDY_DETECTOR_DILATE_ITER = 1  # 1
    TWIST_CANDY_DETECTOR_BG_SIZE_FILTER = 2000
    TWIST_CANDY_DETECTOR_SURE_FG_THRES = 10
    TWIST_CANDY_DETECTOR_RESTORE_FG_THRES = 0.0
    TWIST_CANDY_DETECTOR_BOX_DIM_THRES = 100  # 50
