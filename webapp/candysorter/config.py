...
class DefaultConfig(object):
    ...
    CANDY_DETECTOR_HISTGRAM_THRES = 2.7e-3  # 2.7e-3
    CANDY_DETECTOR_BIN_THRES = 150  # 150
    CANDY_DETECTOR_EDGE3_THRES = 250  # 250
    CANDY_DETECTOR_EDGE5_THRES = 23010  # 230
    CANDY_DETECTOR_MARGIN = (30, 30)  # (30,30)
    CANDY_DETECTOR_CLOSING_ITER = 2
    CANDY_DETECTOR_OPENING_ITER = 5
    CANDY_DETECTOR_ERODE_ITER = 1  # 25
    CANDY_DETECTOR_DILATE_ITER = 1  # 1
    CANDY_DETECTOR_BG_SIZE_FILTER = 2000
    CANDY_DETECTOR_SURE_FG_THRES = 10
    CANDY_DETECTOR_RESTORE_FG_THRES = 0.0
    CANDY_DETECTOR_BOX_DIM_THRES = 100  # 50
